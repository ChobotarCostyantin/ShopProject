...
namespace Orders.BLL.Features.OrderShipping.Services.Interfaces
{
    ...
    {
        Task<Result<OrderShippingDto?>> GetOrderShippingByIdAsync(GetOrderShippingByIdRequest request, CancellationToken cancellationToken);
        Task<Result<OrderShippingDto?>> GetOrderShippingByOrderIdAsync(GetOrderShippingByOrderIdRequest request, CancellationToken cancellationToken);
